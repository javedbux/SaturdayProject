...
{
    public class RequirementDetailMap : EntityTypeConfiguration<RequirementDetail>
    {
        public RequirementDetailMap()
        {
            // Primary Key
            this.HasKey(t => new { t.RequirementID, t.JobDescription, t.Platforms, t.Technology, t.Experiance, t.Qualifications, t.DivisionID, t.DivisionName, t.CountryID, t.CountryName, t.StateID, t.SateName, t.CityID, t.CityName, t.PerferedSkill, t.JobType, t.Priority, t.CreateDate, t.CreatedBy, t.Status, t.IsDeleted });
            ...
            this.ToTable("RequirementDetails");
